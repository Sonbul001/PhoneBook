...
<body>
    ...
    <form action="update_contact.php" method="post">
            ...
            <div class="form">
            <label for="name">Name: </label><br>
            <input type="text" name="name" id="newname"><br>
            <label for="number">New number: </label><br>
            <input type="text" name="number" id="newnumber"><br>
            <!-- a text saying "contact updated successfully" should pop up if the operation was successful -->
        </form>
    </div>
            <button type="submit" value="Update Contact" onclick="lolo();" >Delete Contact</button>
            <?php
                $name = $_POST['name'];
                $file = fopen("contacts.txt", "r");
